    ...
    <>
      ...
      >
        <img 
          src={npcPortrait}
          alt="NPC portrait"
          className="w-128 h-128 object-contain drop-shadow-2xl"
        />
      </div>
      
      {/* Dialogue text in upper center */}
      <div 
        className="fixed top-8 left-8 right-8 mx-auto max-w-3xl z-50 transition-all duration-1000 ml-[34rem]"
        style={{
          opacity: isVisible ? 1 : 0,
            ...
            {dialogue.choices && dialogue.choices.length > 0 && (
              dialogue.choices.map((choice, index) => (
                <button
                  ...
                  className="w-full text-left px-6 py-4 bg-gray-800/90 hover:bg-gray-700 text-white rounded-lg border-2 border-gray-600 hover:border-yellow-400 transition-all text-lg font-['Helvetica'] hover:scale-105 transform"
                >
